...
class point():    ##cree la fonction point
    ...
    def __init__(self,m,dt,Ox,Oy,range):    ##initialisation (self = lui meme) tout les variable sont propres a luis
        ...
        self.vx = 100
        self.vy = 50
        self.id = id +1  ##pour donner a chaque oiseaux une id unique pour des resons de debug
        id = id +1
    ...
    def coins(self):              ## Fais passer de l'autre coter les points si il touche le bord
